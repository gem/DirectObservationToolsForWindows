...
Friend Class clsATCProjection
    ...
    Dim pDefaults As clsATCProjection
    Dim pFieldnames As clsATCProjection

    Public Property Defaults() As clsATCProjection
        Get
            Defaults = pDefaults
        End Get
        Set(ByVal Value As clsATCProjection)
            pDefaults = Value
        End Set
    End Property

    Public Property Fieldnames() As clsATCProjection
        Get
    ...
    Public Property d(ByVal Index As Integer) As String
        Get
            Dim r As String = ""
            If Index > 0 And Index <= 6 Then r = pD(Index).ToString()
            Return r
        End Get
        Set(ByVal Value As String)
