    ...
    Private Function AddFromFileDotNetAssembly(ByVal PathToFile As String, ByVal SearchingGUID As Guid) As Boolean
        ...
        Try
            ...
            Catch rtlex As ReflectionTypeLoadException
                'mapwinutility.logger.msg("This file does not appear to contain any plugins compatible with the MapWindow", MsgBoxStyle.OKOnly Or MsgBoxStyle.Information, "Error")
                g_error = rtlex.Message
                Return False
        ...
        Try
            ...
            Try
                ...
                If TypeOf o Is Interfaces.IPlugin Then
                    ...
                    Asm = Nothing
                    o = Nothing
                ElseIf TypeOf o Is PluginInterfaces.IBasePlugin Then
                    Dim plugin As PluginInterfaces.IBasePlugin
                    plugin = CType(o, PluginInterfaces.IBasePlugin)
            ...
            Catch ex As Exception
                g_error = ex.Message
                MapWinUtility.Logger.Msg("The plugin '" & PathToFile & "' failed to load!" + vbCrLf + vbCrLf + "Details: " + ex.ToString())
